...
import { CandidatsL1 } from '../components/Lists_Candidats_Tables/CandidatesL1'
import { useHistory } from "react-router-dom";

export const Pres_L1 = () => {
        ...
        <div>
            ...
            color: '#1d04ad'
                ...
                <select value={selects} onChange={e=>setSelects(e.target.value)}>
                    ...
                    <option>Ambrosius</option>
                    <option>Kassi</option>
                    <option>Margret</option>
                    <option>Eliza</option>
                    <option>Maegan</option>
                </select>
